...
class Model:
    ...
    def predict(self, prio:int, oorz_code:int, oorz_group:int, equip_nr:int, equip_type:int, geo_code:int):
        x_pred = np.array([prio, oorz_code, oorz_group, equip_nr, equip_type,geo_code]).reshape(1, -1)
